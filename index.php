        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Dos habitaciones, Cocina, Comedor y baño</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Bernardino Juncos 1056, esquina Crucero, La Lucila del Mar</p>
              <p>Un hermoso lugar entre arboledas de grandes pinos y calles de arena.</p>
              <cite>Desde $ 80.000 diarios</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Deck con luces y Parrilla al aire libre</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Bernardino Juncos 1056, esquina Crucero, La Lucila del Mar</p>
              <p>Para disfrutar de tarde de mates o unas ricas comidas en la naturaleza.</p>
              <cite>Desde $ 60.000 diarios</cite>
              </blockquote>
            </div>
          </div>
...
<div class="banner-search">
  <div class="container"> 
    <!-- banner -->
    <h3>Alquiler temporal, hace tu reserva, y disfruta del Pinar en la Lucila del Mar</h3>
    <div class="searchbar">
      <div class="row">
        ...
        <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
          <p>Suscribite y recibi todas las novedades.</p>
...
<div class="container">
  <div class="properties-listing spacer"> <a href="buysalerent.php" class="pull-right viewall">View All Listing</a>
    ...
    <img src="images/properties/1.jpg" alt="Imagen sin restricciones" style="width: auto; height: auto;">
</div>
